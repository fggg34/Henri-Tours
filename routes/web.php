...
// English/default frontend URLs: /tours, /blog, /contact
Route::group([], $frontendRoutes);

// Non-English frontend URLs: /fr/tours, /de/blog, /it/contact
Route::prefix('{locale}')
    ->where(['locale' => 'zh_CN|fr|de|he|it|mt|es'])
    ->name('localized.')
