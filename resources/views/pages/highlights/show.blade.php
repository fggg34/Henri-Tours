...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16">
    ...
    <nav class="text-sm text-gray-500 mb-8" aria-label="Breadcrumb">
        <ol class="flex items-center gap-1.5 flex-wrap">
            ...
            <li>/</li>
            <li><a href="{{ route('cities.show', $city->slug) }}" class="text-brand-navy hover:text-brand-navy transition">{{ $city->name }}</a></li>
            <li>/</li>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mb-14">
        ...
        <div class="flex flex-col justify-center">
            <div class="flex items-center gap-2 mb-3">
                <a href="{{ route('cities.show', $city->slug) }}" class="inline-flex items-center gap-1.5 text-xs font-medium uppercase tracking-wider text-brand-navy hover:text-brand-navy transition">
            ...
            <div class="mt-6 pt-6 border-t border-gray-100">
                <a href="{{ route('cities.show', $city->slug) }}" class="inline-flex items-center gap-2 px-5 py-2.5 bg-brand-btn hover:bg-brand-btn-hover text-white text-sm font-medium rounded-lg transition-colors">
    ...
    <section class="pt-10 border-t border-gray-200 overflow-hidden">
        <div class="flex items-end justify-between mb-8">
            <div>
                ...
                <h2 class="text-2xl md:text-3xl font-bold text-gray-900">More places to visit in {{ $city->name }}</h2>
            </div>
        ...
        <div class="swiper highlight-more-swiper overflow-visible">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a href="{{ route('cities.highlights.show', [$city->slug, $other->slug]) }}" class="group block relative rounded-xl overflow-hidden bg-gray-200" style="aspect-ratio: 4/3;">
                        @if($other->image_url)
