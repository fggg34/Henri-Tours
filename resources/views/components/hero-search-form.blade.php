@props(['action' => route('tours.search'), 'cities' => collect()])
        ...
        <div class="bg-white/95 backdrop-blur rounded-lg shadow-xl p-4 md:p-5">
            <div class="flex flex-col md:flex-row gap-3 md:gap-4 items-stretch">
                ...
                <div class="flex-1 relative">
                    <label class="block text-xs font-semibold text-gray-600 mb-1.5 text-left">Search your destination</label>
                    <div class="relative">
                        <svg class="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
                        <input type="text" name="q" placeholder="Keyword" value="{{ request('q') ?? request('keyword') }}"
                ...
                {{-- Date --}}
                <div class="flex-1 relative">
                    <label class="block text-xs font-semibold text-gray-600 mb-1.5 text-left">Select Date</label>
                    <div class="relative" x-ref="dateContainer">
                        <svg class="absolute z-10 left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                        <input
                            type="text"
                            x-ref="dateInput"
